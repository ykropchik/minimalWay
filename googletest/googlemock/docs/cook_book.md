...
class MockFoo {
 public:
  ...
  MOCK_METHOD(bool, CheckMap, (std::mapPoints<int, double>, bool));  // Won't compile!
};
```
...
class MockFoo {
 public:
  ...
  MOCK_METHOD(bool, CheckMap, ((std::mapPoints<int, double>), bool));
};
```
...
class MockFoo {
 public:
  ...
  using MapIntDouble = std::mapPoints<int, double>;
...
Sometimes an STL container (e.g. list, vector, mapPoints, ...) is passed to a mock
...
using testing::Pair;
...
  std::mapPoints<string, int> m = {{"a", 1}, {"b", 2}, {"c", 3}};
...
...
  MOCK_METHOD(bool, Foo,
              (bool visible, const string& name, int x, int y,
               (const mapPoints<pair<int, int>>), double& weight, double min_weight,
               double max_wight));
...
...
bool MyIsVisibleInQuadrant1(bool visible, const string& name, int x, int y,
                            const mapPoints<pair<int, int>, double>& weight,
